...
<?php endif; ?>
            ...
            <div class="d-flex gap-2 flex-wrap mb-3">
                <a class="btn btn-outline-dark" href="<?= htmlspecialchars(coolopz_job_service_report_url((string) $job['client_update_token']), ENT_QUOTES, 'UTF-8') ?>" target="_blank" rel="noopener noreferrer">View Service Report</a>
            </div>
